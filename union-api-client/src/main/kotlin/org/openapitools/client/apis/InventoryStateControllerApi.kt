...
interface InventoryStateControllerApi {
    ...
    suspend fun apiEnumsInventoryStatesGet(): Response<GetAllResponse>
    ...
    suspend fun apiEnumsInventoryStatesIdGet(@Path("id") id: kotlin.String): Response<EnumGetResponse>
