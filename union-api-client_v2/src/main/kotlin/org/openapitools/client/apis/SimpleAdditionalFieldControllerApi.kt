...
interface SimpleAdditionalFieldControllerApi {
    ...
    suspend fun apiCatalogsSimpleAdditionalFieldGet(@Query("requestsParameters") requestsParameters: ApiSecurityUserRolesGetRequestsParametersParameterV2, @Query("pageable") pageable: PageableV2): Response<GetAllResponseV2>
