...
interface NomenclatureApplicationHistoryControllerApi {
    ...
    suspend fun apiDocumentsNomenclatureApplicationHistoryGet(@Query("requestsParameters") requestsParameters: ApiSecurityUserRolesGetRequestsParametersParameterV2, @Query("pageable") pageable: PageableV2): Response<GetAllResponseV2>
