...
interface SyncControllerApi {
    ...
    suspend fun apiSyncSyncIdExportPartsExportPartIdGet(@Path("syncId") syncId: kotlin.String, @Path("exportPartId") exportPartId: kotlin.String): Response<GetResponseV2>
