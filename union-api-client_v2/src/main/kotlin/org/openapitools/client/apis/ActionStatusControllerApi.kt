...
interface ActionStatusControllerApi {
    ...
    suspend fun apiEnumsActionStatusesGet(): Response<GetAllResponseV2>
    ...
    suspend fun apiEnumsActionStatusesIdGet(@Path("id") id: kotlin.String): Response<EnumGetResponseV2>
