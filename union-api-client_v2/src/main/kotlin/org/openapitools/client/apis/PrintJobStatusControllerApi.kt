...
interface PrintJobStatusControllerApi {
    ...
    suspend fun apiEnumsPrintJobStatusesGet(): Response<GetAllResponseV2>
    ...
    suspend fun apiEnumsPrintJobStatusesIdGet(@Path("id") id: kotlin.String): Response<EnumGetResponseV2>
