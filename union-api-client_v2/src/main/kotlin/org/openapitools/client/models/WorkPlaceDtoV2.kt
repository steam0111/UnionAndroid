 ...
 * @param name 
 * @param premisesId 
 * @param extendedPremises 
 * @param fullName 
 */

data class WorkPlaceDtoV2 (
    ...
    @Json(name = "premisesId")
    val premisesId: kotlin.String? = null,

    @Json(name = "extendedPremises")
    val extendedPremises: PremisesDtoV2? = null,
