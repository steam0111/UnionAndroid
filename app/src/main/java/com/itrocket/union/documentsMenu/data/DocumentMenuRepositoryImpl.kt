...
class DocumentMenuRepositoryImpl : DocumentMenuRepository {
    ...
    override suspend fun getDocuments(): List<DocumentMenuDomain> {
        return listOf(
            DocumentMenuDomain(titleId = R.string.main_identification, iconId = R.drawable.ic_indentyfication),
            DocumentMenuDomain(titleId = R.string.main_marking, iconId = R.drawable.ic_marking),
            DocumentMenuDomain(titleId = R.string.main_accounting_object, iconId = R.drawable.ic_accounting_object),
            ...
            DocumentMenuDomain(titleId = R.string.main_documents, iconId = R.drawable.ic_documentation, paddings = 9),
            DocumentMenuDomain(titleId = R.string.main_commissioning, iconId = R.drawable.ic_commisioning),
